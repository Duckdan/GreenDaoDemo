...
import study.com.greendaodemo.dao.DaoSession;
 ...
 * DAO for table "USER".
 */
public class UserDao1 extends AbstractDao<User, Void> {
    ...
    public UserDao1(DaoConfig config) {
        super(config);
    }

    public UserDao1(DaoConfig config, DaoSession daoSession) {
